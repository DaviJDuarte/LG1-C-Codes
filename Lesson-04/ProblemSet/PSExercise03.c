...
// generates a new RA by reversing the order of the 2 most significant
// digits and the 2 least significant digits in the initial RA. For
// example, if the initial RA is 972845236, the new RA should be 792845263.
// Similarly, if the initial RA is 984475213, the new RA should be
// 894475231. The program should read the initial RA and print the newly
// generated RA.
